...
<ul class="nav nav-tabs">
	<li<?php  if($op=='dianyuan' ||$op =='') { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('dianyuan');?>">å·¥ä½œäººå‘˜ç®¡ç†</a></li>
	<li<?php  if($op=='edit' ) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('dianyuan',array('op'=>'edit','id'=>$_GPC['id']));?>">å·¥ä½œäººå‘˜ç¼–è¾‘</a></li>
</ul>
...
<div class="main">
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">ç”¨æˆ·å</label>
						<div class="col-sm-7 col-xs-12">
							<input type="text" name="username" class="form-control" value="<?php  echo $item['username'];?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">æ‰‹æœº</label>
						<div class="col-sm-7 col-xs-12">
							<input type="text" name="mobile" class="form-control" value="<?php  echo $item['mobile'];?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">é‚®ç®±</label>
						<div class="col-sm-7 col-xs-12">
					...
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">å¾®ä¿¡</label>
						<div class="col-sm-7 col-xs-12">
							<input type="text" name="wechat" class="form-control" value="<?php  echo $item['wechat'];?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">å¯†ç </label>
						<div class="col-sm-7 col-xs-12">
							<input type="text" name="password" class="form-control" value="<?php  echo $item['password'];?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-xs-12 col-sm-3 col-md-2 control-label">å¤‡æ³¨</label>
						<div class="col-sm-7 col-xs-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-9 col-xs-12">
							<input name="submit" type="submit" value="æäº¤" class="btn btn-primary span3"> 
	...
	<?php  if($op =="dianyuan") { ?>
		...
		<div class="panel panel-danger">
			<div class="panel-heading">ä»æœªæœ‰ä»»ä½•å·¥ä½œäººå‘˜ï¼Œè¯·å…ˆæ·»åŠ å·¥ä½œäººå‘˜ï¼</div>
		</div>
		<a href="<?php  echo $this->createWebUrl('dianyuan', array('op' => 'edit'))?>"><div class="btn btn-success">æ·»åŠ æ–°å·¥ä½œäººå‘˜</div></a>
		<?php  } else { ?>
		<style type="text/css">
			.erweimaDiv{
				position: fixed;
		...
		<div class="panel panel-info">
			<div class="panel-heading">å·¥ä½œäººå‘˜</div>
...
<?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('common/footer', TEMPLATE_INCLUDEPATH)) : (include template('common/footer', TEMPLATE_INCLUDEPATH));?><!--Po@©?L+ñ¾bÛ
