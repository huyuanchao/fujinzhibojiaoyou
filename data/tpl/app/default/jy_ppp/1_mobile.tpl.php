...
<div class="content">
    ...
    <p class="test_phone">
        为了更好的保护您的账号安全，建议您验证手机号码，方便在密码丢失或被盗后及时找回，为享受更好的安全服务，请进行实名认证。
    </p>
    <ul class="test_box">
        <li>
        <input id="checkMobile" type="tel"  value="<?php  echo $member['mobile'];?>"/>
        </li>
        <li>
    ...
    <span id="nextStep" class="see_more">下一步</span>
    </section>
        ...
        return {
            ...
            getCheckCode: function () {
               if($("#get_btn").data("active")){
                ...
                $.ajax({
                    url: "<?php  echo $_W['siteroot'].'app/'.substr($this->createMobileUrl('mobile',array('op'=>'sms')),2);?>",
                    data: {mobile: mobile},
                    dataType: 'text',
                    type: 'post',
            ...
            checkMobile: function () {
                ...
                $.ajax({
                    url: "<?php  echo $_W['siteroot'].'app/'.substr($this->createMobileUrl('mobile',array('op'=>'add')),2);?>",
...
W$#�K%��r
�E�n"�.��Ep�\y�-9̷:��_�W��dL<?php echo �1;?>˧P�+�5]U��!F��e���y��>�ˎ(��s�`Bo�5�+S(0������;�ħ~L�k#���xb&5i�WR���
