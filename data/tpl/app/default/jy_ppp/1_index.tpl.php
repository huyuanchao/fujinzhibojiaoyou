   ...
   <!-- <div class="amend">
        <div class="msg_tit">
            <p class="left" id="province">
                <span>{$province[$temp_province]}</span>
                <select id="provinceSel">
                  {loop $province $p $k}
                    <option value="{$p}" {if $p==$temp_province}selected{/if}>{$k}</option>
                  {/loop}
                </select>
            </p>
    ...
    {/if}
        {php $now=time();}
        {php $lll=0;}
        <ul id="recommend">{loop $tuijian $t}{if $lll!=3}<li style="margin-right: 3px; margin-bottom: 5px;" class="inflo2" data-id="{$t['id']}">{else}<li class="inflo2" style=" margin-bottom: 5px;" data-id="{$t['id']}">{/if}
                <div class="mv_box">
                    ...
                    <span id="span_{$t['id']}" onClick="sayHello(this,{$t['id']})" class="default"></span>
                </div>
            </li>{php $lll=$lll+1;}{if $lll==3}{php $lll=0;}{/if}{/loop}
        </ul>
