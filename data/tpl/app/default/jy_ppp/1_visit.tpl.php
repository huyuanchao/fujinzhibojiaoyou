...
<head>
    ...
    <style type="text/css">
        a>.user-list>li.foot-icon>img{width: 50px;height: 61px;border-radius: 3px;}
    </style>
</head>
<body>
...
<div class="content">
    ...
    <script>
        function moreMsg(obj){
            ...
            $.post("{php echo $_W['siteroot'].'app/'.substr($this->createMobileUrl('visit',array('op'=>'more')),2)}"+"&lastid="+lastid,function(data){
                if(data.status==1)
                {
