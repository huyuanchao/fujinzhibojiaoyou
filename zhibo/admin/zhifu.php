...
$type="money1='$_POST[moeny1]',money2='$_POST[moeny2]',money3='$_POST[moeny3]',money4='$_POST[moeny4]',money5='$_POST[moeny5]',daxiu1='$_POST[daxiu1]',daxiu2='$_POST[daxiu2]',zhibo1='$_POST[zhibo1]',zhibo2='$_POST[zhibo2]'   where id='1'";
upalldt(ubozf,$type);
...
<head>
<meta charset="gb2312">
<title>金额设置  - 8ye.net 八爷资源网</title>
