...
$username = trim($_GET['log_id']); //   http://域名/codepay/?user=admin 访问则自动填写了账户信息
                ...
                <ul id="ulBankList">
                    ...
                    <li class="gray6"
                        ...
                        <!-- 充值用户名： --><label
                            ...
                            <input type="hidden" name="user" id="user" placeholder="用户名" value="<?php echo $user ?>"
