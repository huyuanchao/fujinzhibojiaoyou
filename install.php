...
define('APP_URL', '//101.42.103.38/web/');
define('APP_STORE_URL', '//101.42.103.38/web');
define('APP_STORE_API', '//101.42.103.38/api.php');
if($_GET['res']) {
	$res = $_GET['res'];
	$reses = tpl_resources();
...
<html lang="zh-cn">
	<head>
		...
		<title>安装系统 - 微擎 - 公众平台自助开源引擎  - www.niumawu.com 牛码屋源码网</title>
